...
<body>
    ...
    <h4><a href="OperationServlet.do">02_EL의 연산자</a></h4>

    <h1>JSP Action Tag</h1>
    <%--
        *JSP를 이루는 구성
        1. 스크립팅원소 : jsp페이지내에서 자바코드를 집접기술할수 있게 하는 기술
            ex) 스크립틀릿, 표현식...

        2. 지시어 : JSP페이지 정보에 대한 내용을 표현한다거나 또 다른페이지를 표함할 때 사용
